...
var AccountsElement = require("./account-business");
module.exports = {
...
function getClientElement(client) {
  ...
  var ul = AccountsElement.getClientAccountsElement(clientAccounts);
  node.appendChild(ul);
  return node;
}
...
var GetClientElement = require("./client-business");
module.exports = {
...
function printClientsAccounts() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var element = GetClientElement.getClientElement(client);
...
var PrintClient = require("./client-list-business");
window.onload = function () {
  PrintClient.printClientsAccounts();
};
